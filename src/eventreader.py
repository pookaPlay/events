...
class EventReader(EventReaderAbstract):
    def __init__(self, filepath: Path, dt_milliseconds: int, st_milliseconds: int):
        super().__init__(filepath)
        self.event_slicer = EventSlicer(self.h5f)

        self.st_us = int(st_milliseconds * 1000)
        ...
        self._length = (self.t_end_us - self.t_start_us)//self.st_us
    ...
    def __next__(self):
        ...
        self.t_start_us = self.t_start_us + self.st_us
